          ...
          <div class="container px-4 mx-auto">
            ...
            <div class="flex justify-center">
                <svg
								...
								fill="none"
							>
								<circle opacity="0.3" cx="32" cy="32" r="32" fill="#54D769"></circle>
								<circle cx="32" cy="32" r="24" fill="#54D769"></circle>
								<path
            ...
            <p class="text-center my-4 px-8 font-semibold lg:text-lg max-w-md mx-auto ">
              $ 200 has been <br> top up to your account
            </p>
