            ...
            <div class="bg-white w-full max-w-2xl rounded-xl mx-auto">
                <div class="py-8">
                    <div class="container px-4 mx-auto">
                        ...
                        >
                            Delete account {{ store.currentAccount }}?
                        </p>
                        <p
                            class="text-center text-slate-500 mb-6 lg:text-sm max-w-md mx-auto"
                        >
                            Your money will be gone forever!
                        </p>
                        <div class="flex justify-center space-x-4">
                            <button
                                class="px-5 py-1 bg-slate-200"
                                @click="goBack"
                            >
                                No
                            </button>
                            <button
                                class="px-5 py-1 text-red-600 font-bold"
                                @click="$emit('confirm')"
                            >
                                Yes
                            </button>
