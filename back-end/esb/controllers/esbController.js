...
//     const response = await fetch(`${process.env.USER_SERVICE_URL}api/v1/user/${id}`, {
//         method: 'GET',
//         headers: {
...
exports.signup = catchAsync(async (req, res, next) => {
    const response = await fetch(`${process.env.AUTH_SERVICE_URL}api/v1/auth/signup`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
exports.logout = catchAsync(async (req, res, next) => {
    const response = await fetch(`${process.env.AUTH_SERVICE_URL}api/v1/auth/logout`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
        }
