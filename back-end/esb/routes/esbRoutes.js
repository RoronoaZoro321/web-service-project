...
router.post("/users/getUserById", protect, esbUserController.getUserById);
...
router.post(
    ...
    protect,
    esbUserController.createAccount
);
router.get(
    "/users/accounts/getAccountsByUserId",
    protect,
    esbUserController.getAccountsByUserId
);
router.post(
    "/users/accounts/getAccountById",
    protect,
    esbUserController.getAccountById
);
router.post(
    "/users/accounts/getAccountByAccountNumber",
    protect,
    esbUserController.getAccountByAccountNumber
);
router.delete(
    "/users/accounts/deleteAccountById",
    protect,
    esbUserController.deleteAccountById
);
...
router.post(
    ...
    protect,
    esbTransactionController.transfer
);
router.post(
    "/transaction/MyAccTransactions",
    protect,
    esbTransactionController.getAllTransactionsByAccountId
);
